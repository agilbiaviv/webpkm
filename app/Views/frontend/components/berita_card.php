<article class="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition-shadow overflow-hidden flex flex-col animate-fade-in">
    ...
    <div class="p-4 flex flex-col flex-1">
        <small class="text-sm text-gray-500 dark:text-gray-400 mb-4 flex items-center gap-3 flex-wrap">
            <span>Diposting pada <?= dateFormat($item['tanggal_berita']) ?> |</span>
        ...
        <a href="<?= base_url('berita/' . $item['slug']) ?>" class="font-semibold text-xl mb-2 text-orange-500 dark:text-orange-400 hover:text-orange-600 min-h-[64px]">
            <?= esc(strip_tags($item['judul_berita'])) ?>
        </a>
